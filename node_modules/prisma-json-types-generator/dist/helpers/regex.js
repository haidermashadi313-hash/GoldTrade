...
function isUpdateOneType(type) {
    return (type.match(/UpdateInput$/m) ||
...
function generateTypeNamesFromName(name) {
    const types = [];
    // Prisma capitalizes the model name for output types
